...
#sys.path.append('/home/christian/Documents/vibe2/src/3dparty/opus/src/')
#sys.path.append('/home/christian/Documents/vibe2/src/3dparty/src/opus_core/tools')
import os
...
class VIBeOptions:
    def __init__(self, YearsToRun):
        self.xml_configuration=None
        self.configuration_path='vibe_min_parcel.configs.baseline'
        self.pickled_resource_file = None
        self.database_name = 'services'
        self.database_configuration = 'services_database_server'
        self.run_as_single_process = True
        self.years_to_cache = None
        self.profile_filename= None
        self.scenario_name = None
        self.existing_cache_to_copy =None
